...
<section class="home" id="home">
    ...
    <div class="content">
        <img class="tilt" src="{{asset('forntend/images/about-pic.jpg')}}" alt="">
...
<section class="portfolio" id="portfolio">
    ...
    <div class="box-container">
        ...
        <div class="box tilt">
            <img src="{{asset('forntend/images/img-1.jpg')}}" alt="">
            <div class="content">
        ...
        <div class="box tilt">
            <img src="{{asset('forntend/images/img-2.jpg')}}" alt="">
            <div class="content">
                <a href="#" class="btn">learn more</a>
            </div>
        </div>
        ...
        <div class="box tilt">
            <img src="{{asset('forntend/images/img-3.jpg')}}" alt="">
            <div class="content">
                <a href="#" class="btn">learn more</a>
            </div>
        </div>
        ...
        <div class="box tilt">
            <img src="{{asset('forntend/images/img-4.jpg')}}" alt="">
            <div class="content">
                <a href="#" class="btn">learn more</a>
            </div>
        </div>
        ...
        <div class="box tilt">
            <img src="{{asset('forntend/images/img-5.jpg')}}" alt="">
            <div class="content">
                <a href="#" class="btn">learn more</a>
            </div>
        </div>
        ...
        <div class="box tilt">
            <img src="{{asset('forntend/images/img-6.jpg')}}" alt="">
            <div class="content">
                <a href="#" class="btn">learn more</a>
            </div>
        </div>
...
<section class="contact" id="contact">
    ...
    <div class="row">
        ...
        <div class="image">
            <img class="tilt" src="{{asset('forntend/images/contact-img.svg')}}" alt="">
        </div>
...
<!-- particles.js links  -->
<script src="{{asset('forntend/js/particles.min.js')}}"></script>
<script src="{{asset('forntend/js/app.js')}}"></script>
